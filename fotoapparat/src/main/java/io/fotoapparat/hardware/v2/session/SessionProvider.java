...
public class SessionProvider implements TextureManager.Listener {
    ...
    private ContinuousSurfaceReader surfaceReader2;
    ...
    public SessionProvider(StillSurfaceReader surfaceReader,
        ...
        this.surfaceReader2 = continuousSurfaceReader;
    ...
    public void onSurfaceAvailable(Surface surface) {
        ...
        Surface captureSurface2 = surfaceReader2.getSurface();
        List<Surface> surfaces = Arrays.asList(surface, captureSurface,captureSurface2);
